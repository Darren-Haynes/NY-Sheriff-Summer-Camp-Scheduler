...
export class Schedule {
  ...
  private getKidsbyActivityChoice(
    ...
    const unscheduledKidsNames = this.getUnscheduledKidsList(activityType, timeSlot)
...
/**
  ...
  */
  ...
  private testScheduling(activityType: AllowedActivityTypes, func_name: string): void {
    ...
    const land9amTotalLength = this.notScheduled9amLand.names.length + this.scheduled9amLand.names.length === this.kids.count / 2;
    const land10amTotalLength = this.notScheduled10amLand.names.length + this.scheduled10amLand.names.length === this.kids.count / 2;
    ...
    if (waterTotalCount !== totalKidsCount) {
      ...
      console.log("Land Scheduled # MATCHES YAY. this.Kids.timeSlots == this.kids.totalKidsCount: ")
      console.log(waterTotalCount, "==", totalKidsCount, "\n\n")
    }

    console.log("Land totals:")
